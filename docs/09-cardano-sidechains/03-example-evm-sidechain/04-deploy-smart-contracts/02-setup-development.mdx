...
- Search the transaction hash or contract address on the EVM sidechain
  [testnet explorer](https://explorer.sidechain.evmtestnet.iohkdev.io/).
...
contract address which can be searched on the EVM sidechain
[testnet explorer](https://explorer.sidechain.evmtestnet.iohkdev.io/).
