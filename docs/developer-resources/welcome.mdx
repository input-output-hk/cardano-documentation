...
- To get started, head over to the
  ...
  [install](https://developers.cardano.org/docs/get-started/installing-cardano-node)
  and [run](https://developers.cardano.org/docs/get-started/running-cardano) the
  Cardano node and
