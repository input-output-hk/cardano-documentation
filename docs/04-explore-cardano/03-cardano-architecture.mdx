...
[consensus](https://docs.cardano.org/learn/consensus-explained) about the
system’s state.
...
You can only trust nodes run by you or your organization. This is why
[Daedalus](https://docs.cardano.org/cardano-components/daedalus-wallet) runs a
