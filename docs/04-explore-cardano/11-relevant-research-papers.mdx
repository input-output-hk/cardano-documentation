...
[A Formal Specification of the Cardano Ledger with a Native Multi-Asset Implementation](https://github.com/input-output-hk/cardano-ledger/releases/latest/download/mary-ledger.pdf 'A Formal Specification of the Cardano Ledger with a Native Multi-Asset Implementation')
