...
> If you want to install and run the SMASH server, you can use
> [these instructions](https://github.com/input-output-hk/smash/blob/master/doc/getting-started/how-to-install-smash.md).
