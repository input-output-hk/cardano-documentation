...
A [stake pool](/core-concepts/stake-pools) is a reliable server node that holds
and maintains the combined stake of various stakeholders in a single entity.
Stake pools use the [Cardano node](https://docs.cardano.org/learn/cardano-node/)
to validate how the pool interacts with the network and are responsible for
...
- A _stake pool owner_ is a person who pledges their stake to the pool to
  ...
  the owner to [pledge stake](/core-concepts/pledging-rewards) provides
