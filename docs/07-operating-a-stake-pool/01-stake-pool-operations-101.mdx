...
[v.8.1.2](https://github.com/input-output-hk/cardano-node/releases/tag/8.1.2)  
...
This release is mainnet ready and has significant improvements at epoch
boundary. All SPOs are strongly encouraged to update.

Node 8.1.2 is a minor release of the Cardano node, which updates the Plutus
interpreter.
