...
environment, Cardano supports the development and deployment of smart contracts
using such programming languages as:
...
Currently, there are more smart contract languages and tools to build on
Cardano. For more details, see:
