...
[Cardano node](https://docs.cardano.org/core-concepts/cardano-node), and it
stores the entire history of Cardano blockchain and validates all blocks and
transactions for fully trustless and autonomous operation.
...
> [visit the dedicated Helpdesk page <OpenInNew className='content-link' />](https://iohk.zendesk.com/hc/en-us/categories/360000877653-Daedalus-Mainnet)
