---
title: Learn about Rosetta
metaTitle: Learn about Rosetta
---
...
We have created our unique `cardano-rosetta` implementation to simplify the process of integration with [Cardano](https://cardano.org/). To put this into context and illustrate the different implementations of Rosetta, bitcoin-rosetta and ethereum-rosetta also exist. The commonality between all implementations is that they all share the same interface.
