...
The _Cardano node_ is the top-level component within the network. Network nodes
...
_Stake pools_ use the Cardano node to validate how the pool interacts with the
...
consensus protocol provides transparency and decides which candidate blocks
...
The Cardano blockchain uses the Ouroboros Praos protocol to facilitate consensus
...
aggregated stake of their owners and other delegators, also known as
stakeholders. Slot leaders are elected randomly from among the stake pools. The
more stake the pool controls, the greater the chance it has of being elected as
a slot leader to produce a new block that is accepted into the blockchain. This
is the concept of proof-of-stake (PoS).
...
-   [Cardano node](/core-concepts/cardano-node)
-   [About the Cardano network](/explore-cardano/cardano-network/about-the-cardano-network)
-   [Operating a stake pool](/getting-started/operating-a-stake-pool/about-stake-pools)
