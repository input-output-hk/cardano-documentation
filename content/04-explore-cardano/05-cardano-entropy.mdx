...
The --extra-entropy argument looks different from the _extraEntropy field displayed after a transaction is created. This difference is explained in the [nonce explanation page](https://docs.cardano.org/explore-cardano/explain-nonce/).
