...
We maintain a dedicated site with documentation and example queries:

[input-output-hk/data-analytics-bigquery](https://github.com/input-output-hk/data-analytics-bigquery/wiki)
...
Access our [Cardano on BigQuery - data schema browser](https://datastudio.google.com/reporting/0d60645a-95dd-4531-b85d-7b811fadc351).

The [wiki](https://github.com/input-output-hk/data-analytics-bigquery/wiki/Database-schema) also contains more information about the table schema.
