...
Please note that [node version 1.29.0](https://github.com/input-output-hk/cardano-node/releases/tag/1.29.0) is the only node version that will work following the upcoming Alonzo protocol update.
...
|---|---|---|---|---|---|---|
| __[1.30.1](https://github.com/input-output-hk/cardano-node/releases/tag/1.30.1)__ |[11.0.3](https://github.com/input-output-hk/cardano-db-sync/releases/tag/11.0.3)|||| ||****
