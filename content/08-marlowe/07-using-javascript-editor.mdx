...
6. Then click **Send to Simulator** in the top right-hand corner. 
    ...
    You can also find more details about simulation in the [Marlowe tutorial](https://alpha.marlowe.iohkdev.io/doc/marlowe/tutorials/javascript-embedding.html). 
