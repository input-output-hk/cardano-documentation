...
7. Then, click **Send to Simulator**. 
   ...
   The Simulator allows you to simulate Marlowe contracts transaction by transaction. You can find more instructions on how to use the Haskell editor in the [Marlowe tutorial](https://alpha.marlowe.iohkdev.io/doc/marlowe/tutorials/embedded-marlowe.html).
