...
A confirmation card is displayed, as follows:

![pay-start](pay-start.png)

12. Click **Pay and start** to run your contract.
The running contract dialog is displayed. This shows a counter with the time allocated within which the seller must make a deposit.
