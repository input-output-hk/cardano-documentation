...
such rule is
[the minimum UTXO value](https://cardano-ledger.readthedocs.io/en/latest/explanations/min-utxo.html)
...
or [cardano-rosetta](https://docs.cardano.org/rosetta/learn-rosetta).
...
asset in and address in your wallet adhering to the network guidelines and the
minimum UTXO value.
...
> [minimum ada value requirement topic](https://cardano-ledger.readthedocs.io/en/latest/explanations/min-utxo.html)
