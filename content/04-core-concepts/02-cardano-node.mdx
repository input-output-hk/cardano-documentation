...
you to participate in the Cardano decentralised blockchain. Ultimately, a
...
network it is defined by the Ouroboros protocol. By running a Cardano node, you
...
other packages: consensus, ledger and networking, configuration, CLI, as well as
logging and monitoring. Note that cardano-node no longer incorporates wallet or
explorer functionality. The wallet backend and explorer backend are separate
