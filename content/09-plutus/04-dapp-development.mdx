...
-   [plutus-cborhex-automatiom](https://github.com/SIDANWhatever/plutus-cborhex-automation): an open-source library to build RESTful API for paramerterized plutus script
