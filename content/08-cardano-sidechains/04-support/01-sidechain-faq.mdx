...
Yes, IOG is working in a less resource-intensive tool. There are other chain indexer tools such as [Oura](https://github.com/txpipe/oura) and [Carp](https://github.com/dcSpark/carp)[Carp](https://github.com/dcSpark/carp) that could serve the purpose of building a Cardano sidechain.

### Why is the transfer token time between main chain and sidechain in a mainnet scenario 12 hours? 
