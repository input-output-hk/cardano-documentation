...
1. We will use the **sidechain-cli** within this tutorial. Download the binary and add it to your shell’s path: https://github.com/input-output-hk/sidechains-tooling/releases.
...
- Create `/contracts/bridge.abi` with the following contents: [bridge.abi](PENDING_URL)
