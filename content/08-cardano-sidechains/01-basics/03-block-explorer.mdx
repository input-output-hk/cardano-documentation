---
title: 'Block Explorer Glossary'
metaTitle: 'Block Explorer Glossary'
---
# Block Explorer
...
When you use a block explorer, it will list fields and their contents.  
This document will help you understand the meaning of the field names and the
significance of their contents.
# Glossary
These are the field names commonly used in block explorers on the Cardano EVM sidechain.
## General terms
<dl>
  <p></p><dt>
    <strong>Actor</strong>
