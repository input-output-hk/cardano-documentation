---
title: Ouroboros Description
metaTitle: Ouroboros Description
---

# Ouroboros BFT: A simple Byzantine fault tolerant consensus protocol
Ouroboros, named after the symbol of infinity, is the backbone of the Cardano ecosystem. Ouroboros BFT is the version that is implemented in the Cardano EVM sidechain. It is a simple, deterministic protocol for ledger consensus that tolerates Byzantine faults.
