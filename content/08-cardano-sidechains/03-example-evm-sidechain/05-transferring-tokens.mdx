...
3. If you have not done so already, create and fund your main-chain and sidechain accounts: [Create and fund your accounts](../../08-cardano-sidechains/03-example-evm-sidechain/02-create-and-fund-accounts.mdx).
...
Verify the amount you locked in your account:
