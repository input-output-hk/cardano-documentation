...
🎉 Congradulations! At this point, you have successfully claimed your `SC_Token` on the main chain.
...
-  `--sc-url <PENDING_URL>`: Providing the JSON-RPC API url, or endpoint, to the sidechain network node.
...
🎉 Congradulations! At this point, you have successfully burned your main chain `SC_Token` for a native sidechain `SC_Token`.
