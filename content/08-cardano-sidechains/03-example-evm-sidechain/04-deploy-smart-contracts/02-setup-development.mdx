...
🎉 Hurray! You deployed your smart contract to EVM sidechain testnet and can search your deployment on the [testnet explorer](https://explorer.sidechain.evmtestnet.iohkdev.io/).
