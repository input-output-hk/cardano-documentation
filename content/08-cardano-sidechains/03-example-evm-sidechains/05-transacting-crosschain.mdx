...
🎉 At this point you have successfully claimed sidechain fuel tokens. This transaction may take a couple seconds to process.
...
ℹ️ *`4655454c` in hex is the ASCII encoding of the string `FUEL`*
