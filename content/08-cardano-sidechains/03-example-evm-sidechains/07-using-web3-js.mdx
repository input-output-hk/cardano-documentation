...
Line 2 establishes a connection between this program and the Cardano EVM sidechain node.  
The block beginning at line 4 retrieves the latest block that the client has downloaded so far.
## Test the program
