...
Individuals with improvement proposals for [Cardano](https://github.com/input-output-hk/cardano-documentation/pull/159) can structure those thoughts into Cardano Improvement Proposals (CIPs).  
