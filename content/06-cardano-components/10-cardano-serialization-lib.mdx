...
You can find more instructions in the [docs folder here](https://github.com/Emurgo/cardano-serialization-lib/tree/master/doc/getting-started), or follow the link to the repository below.
