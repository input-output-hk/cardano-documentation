...
Usually, the cost is $5 terabyte (TB) of the data queried. Find more information by visiting the [BigQuery pricing page](https://cloud.google.com/bigquery/pricing).
