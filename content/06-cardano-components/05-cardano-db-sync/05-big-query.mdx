...
2. The data is only updated to approximately last 20 blocks before the current block height in DB Sync. This is essential to prevent rollbacks of blocks in the case of chain forks.
...
Usually, the cost is $5 per one table of the data queried. Find more information by visiting the [BigQuery pricing page](https://cloud.google.com/bigquery/pricing).
