...
- Locally stored wallets and encrypted [private keys](https://docs.cardano.org/core-concepts/cardano-keys), not shared with third-party servers
...
- After downloading, the wallet will sync with the blockchain to create a local copy of it. Currently, Daedalus (and the blockchain) take up around 15GB of local storage, mostly in `~/Library/Application\ Support/Daedalus\ Mainnet`. 
