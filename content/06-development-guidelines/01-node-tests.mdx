...
-   [Getting started](https://input-output-hk.github.io/cardano-node-tests/readme.html#). Explains the process of installation  setup, usage, test variables, and more.
