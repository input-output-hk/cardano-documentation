...
This part will show how to redelegate your stake to another stake pool. There can be multiple reasons to redelegate your stake, but the most common ones are:
...
```
Now the delegation certificate contains the `--stake-pool-id` of the new stake pool. It means that you're ready to construct your transaction, selecting first the UTXO from which you will pay the fee.
```
...
```
If you check your stake address info you'll see that you have delegated your stake to a new stake pool and you have zero rewards:
