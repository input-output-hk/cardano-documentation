...
This part of the tutorial will demonstrate how to easy is to claim rewards using the `cardano-cli`. First, you need to ensure that you already have rewards available in your stake address. Check it with the following command:
