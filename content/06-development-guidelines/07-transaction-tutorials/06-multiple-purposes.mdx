...
Cardano allows more complex transactions. So far you've seen various types of transactions: Metadata, simple script, minting, staking, etc. But Cardano provides the flexibility to create more complex transactions and mix all the types of transactions needed. For example, adding metadata to minting transactions, or adding a staking component to a simple script transaction. This tutorial shows sending a transaction with multiple purposes.
