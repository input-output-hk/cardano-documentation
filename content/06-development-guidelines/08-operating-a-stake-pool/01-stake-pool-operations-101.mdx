...
Node 8.1.1 is a minor release of the Cardano node. It implements a fix from ouroboros-network for P2P topologies that don't contain DNS names in local roots.
