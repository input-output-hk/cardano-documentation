...
The cost model for Plutus Core scripts has a number of parameters, which are part of the Cardano protocol parameters. Developers can also adjust those parameters individually. 
