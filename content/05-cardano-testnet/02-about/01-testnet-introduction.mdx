...
>We recommend that all developers, SPOs, and exchanges use these environments rather than the main Cardano testnet. For more details, see [environments overview here](https://docs.cardano.org/cardano-testnet/getting-started/#environments).
