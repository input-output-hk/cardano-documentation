...
metaTitle: Vasil testnet introduction
---
...
The Cardano testnet has been upgraded to Vasil functionality and is now available for public functionality testing. 
...
* check [getting started tutorials](new link)
