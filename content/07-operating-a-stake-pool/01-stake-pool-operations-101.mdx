...
Current node version: [v.8.7.2](https://github.com/input-output-hk/cardano-node/releases/tag/8.7.2)  
...
Cardano node v.8.7.2 brings the CLI refactoring from SanchoNet to mainnet to allow teams ample time to update their components in preparation for v.9.0 release.
