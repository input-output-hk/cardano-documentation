...
- [Creating an operational certificate with key evolving signature (KES)](https://github.com/input-output-hk/cardano-node-wiki/blob/main/docs/stake-pool-operations/7_KES_period.md)
