...
communicate with each other to achieve [consensus](https://docs.cardano.org/core-concepts/consensus-explained) about the system’s state.
...
appeared in the top research conference in cryptology worldwide (the
